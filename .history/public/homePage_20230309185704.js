...
moneyManager.addMoneyCallback = function (data) {
    ApiConnector.addMoney(data, response => {
        if (response.success) {
            ...
            this.setMessage(response.success, isSuccess, message 'Действие выполнено успешно.')
        }
        this.setMessage(response.success, isSuccess, message 'Действие выполнено НЕ успешно.')
    })
}
